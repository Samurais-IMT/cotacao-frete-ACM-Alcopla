        ...
        <form onSubmit={handleSubmitNova} className="space-y-3">
          ...
          >
            {isLoading && loadingType === "nova" ? (
              <><Loader2 className="mr-2 h-4 w-4 animate-spin" />Iniciando cotação...</>
            ) : (
              <><Search className="mr-2 h-4 w-4" />Iniciar cotação</>
            )}
          </Button>
        </form>
      </div>
        ...
        <form onSubmit={handleSubmitBuscar} className="space-y-3">
          ...
          >
            {isLoading && loadingType === "buscar" ? (
              ...
              <><FileSearch className="mr-2 h-4 w-4" />Buscar cotação</>
            )}
          </Button>
        </form>
      </div>
